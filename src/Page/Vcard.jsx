      ...
      <div className="w-full">
        <div className="w-full bg-[#122C6C]  flex justify-center">
          <div className="max-w-md">
            ...
            <div className="flex justify-center flex-wrap items-center text-white w-fit mx-auto mt-14 mb-10">
              <a
                href="tel:0983277941"
        ...
        <div className="w-full flex justify-center ">
          <div className="max-w-md mx-5 w-full">
            ...
            <div className="flex justify-center my-5">
              <button className="py-3 px-4 rounded-lg text-white bg-[#f25b18] hover:bg-orange-700 font-medium">
                {" "}
                + Thêm liên hệ
              </button>
            </div>
